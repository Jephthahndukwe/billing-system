                    ...
                    <div>
                        <div  className='overflow-x-auto h-[65vh] lg:mt-0 xs:mt-[4rem]'>
                            <h2 className='text-[#ff0000] text-[16px] font-[700] leading-[18px] bg-[#ffff00] text-center'>Latest Receivable</h2>
                                <table className='border-collapse'>
                                    <tr>
                                        <th className='bg-[#153450] border-[1px] border-solid border-[#eee] py-[10px] lg:px-[40px] xs:px-[66px] text-center text-[#fff] font-[400]'>CODE</th>
                                        <th className='bg-[#153450] border-[1px] border-solid border-[#eee] py-[10px] lg:px-[40px] xs:px-[66px] text-center text-[#fff] font-[400]'>DATE</th>
                                    </tr>
                                    <tr>
